...
double REhalbe = 100.0/2.0 ;  //RE/2
double EPSILON = 1; //Abbruchfaktor
int T = 10000;//Zeitdauer 
 double tau = 0.5;
double diff;
double anfang = 0;
char dateistring[50];
...
u[I][J_MAX-1]= - u[I][J_MAX-2];}



//Hier ist das Objekt

for (J=10; J<J_MAX-35; J++){// linker Rand fÃ¼r u
u[10][J]=0;
v[10][J]= -v[11][J];}
...
for (J=30; J<J_MAX-15; J++){// linker Rand fÃ¼r v
u[10][J]=0;
v[10][J]= -v[11][J];}
...
if(t<= 100){
    ...
    anfang = t;   
sprintf(dateistring,"plotti_%d.dat",t);  
